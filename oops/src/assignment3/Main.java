...
public class Main {
    public static void main(String[] args) {
        ...
        switch (ch) {
            case 1:
                Programmer p = new Programmer("shubham", 50000);
                p.salary();
                break;
            case 2:
                TeamLead t = new TeamLead("friday", 55000);
                t.salary();
            case 3:
                APM a = new APM("jarvis", 80000);
                a.salary();
            case 4:

                ProjectManager pm = new ProjectManager("edith", 200000);
                pm.salary();
            default:
                break;
        }
